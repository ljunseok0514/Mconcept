	...
	return (
		<footer>
			<div className="bg-grey-500 text-base font-normal text-white">
				<div className="mt-18 m-auto w-[1240px] leading-[58px]">
			...
			<div className="text-grey-400 flex justify-center gap-11 pt-10 text-sm font-normal leading-5">
				<div>
					<dl>
						<dt>상호명 : ㈜더블유컨셉코리아 ㅣ 대표자 : 이은철 ㅣ 주소 : 서울특별시 강남구 테헤란로 231, EAST동 20층(역삼동, 센터필드)</dt>
						<dt>
							사업자등록번호 : 211-88-19183 ㅣ 통신판매업신고 : 제2009호-서울강남-00847호
							<a className="border border-black mx-1 py-[1px] px-2 text-black font-normal" href="/" target="_blank">
								사업자정보확인
							</a>
				...
				<div className="border-gery-300 border-l-[1px] pl-10">
					<dl>
						<dt className="text-black font-medium">소비자피해보상보험</dt>
